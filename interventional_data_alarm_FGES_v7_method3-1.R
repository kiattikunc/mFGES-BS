          ...
          for (row_index in 1:length(Data[[data_index]][["e"]]) )
          {
            if (row_index !=var_index)
            {
              #posterior_obs[var_index,row_index] <- max(posterior_obs[var_index,row_index],ratio_BIC[var_index,data_index+1])
               if(ratio_BIC[row_index,data_index+1] <thred3 & (amat_undirect[var_index,row_index]==3 | amat_undirect[row_index,var_index]==3) )
              {
              ...
              else if (ratio_BIC[row_index,data_index+1] >thred3 & essential_amat[var_index,row_index]==1)
              {
...
#############################################
  ...
  # 
    ...
    #  x <- ugraphToTetradGraph(essential_amat, varNames)
    #  dot(x)
