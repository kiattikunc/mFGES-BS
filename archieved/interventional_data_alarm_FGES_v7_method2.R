          ...
          if (size !=0)
                 {
                      for(sepset_index in 1:size)
                                {
                                  if (length(rule0_graph[["sepsetratio"]][[index_sepset_i]][[index_sepset_j]]) !=0)
                                  {
                                    
                                    v<-rule0_graph[["sk"]]@sepset[[index_sepset_i]][[index_sepset_j]][sepset_index]
                                    ...
                                    amat[index_sepset_i,v] <- max(amat[index_sepset_i,v],ratio)
                                    amat[index_sepset_j,v] <- max(amat[index_sepset_j,v],ratio)
